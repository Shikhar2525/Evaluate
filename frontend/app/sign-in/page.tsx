    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mt-24">
        ...
        <div className="bg-slate-900/50 backdrop-blur-2xl rounded-2xl shadow-2xl p-8 border border-slate-700/50">
          ...
          <p className="text-slate-400 text-center text-sm mb-8">Sign in to access your interviews</p>
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-white text-slate-900 font-semibold rounded-xl transition-all duration-200 hover:bg-slate-50 shadow-lg hover:shadow-xl hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 mb-4 border border-white/10"
          >
            {googleLoading ? (
              <>
              ...
              <>
                ...
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  ...
                  <path fill="#4B5563" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-slate-500 font-medium uppercase">Or email</span>
